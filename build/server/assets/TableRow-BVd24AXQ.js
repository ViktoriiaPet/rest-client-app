...
import { B as Button } from "./server-build-CKmN4_cs.js";
import "node:stream";
...
const TableRow = ({ name, value, onClick }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-4 items-center w-full", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: " flex justify-center items-center", children: /* @__PURE__ */ jsx(Button, { variant: "custom", type: "submit", onClick, children: t("variables.delete") }) })
  ] });
};
export {
  TableRow as default
