...
import { S as n } from './SignButton-CNXYMYwp.js';
import { B as a } from './button-B9xj3Fbv.js';
import { u } from './AuthContext-B8r0X3Wy.js';
import { u as m } from './useTranslation-0WW_tMsO.js';
const p = '/assets/Darya-Cy8thGTo.jpg',
  b = '/assets/alyona-COSDz4be.jpg',
  h = '/assets/vika-CwH6O9av.jpg',
  w = x(function () {
    const { t } = m(),
      { user: r } = u(),
      o = d(),
              ...
              e.jsxs('div', {
                ...
                children: [
                  e.jsx(l, {
                    ...
                    children: e.jsx(n, { text: 'auth.signIn' }),
                  }),
                  e.jsx(l, {
                    to: '/signUp',
                    end: !0,
                    children: e.jsx(n, { text: 'auth.signUp' }),
                  }),
                ],
              }),
            ],
