const __vite__mapDeps = (
  ...
  m = __vite__mapDeps,
  d = m.f ||
    (m.f = ['assets/firebase-BROQ1CJd.js', 'assets/index.esm-BE3Wjq2f.js'])
) => i.map((i) => d[i]);
import {
  d as Ge,
  r as h,
...
import { u as Ut, _ as $t, A as Bt } from './AuthContext-CUzW9ehr.js';
import { i as zt } from './firebase-BROQ1CJd.js';
import { V as Ht } from './VariablesContext-Bs1XEHzk.js';
import { i as qt } from './i18next-Bhq85MQn.js';
import {
  s as Vt,
  a as Wt,
  g as Gt,
  u as ee,
} from './useTranslation-CEuFiQrx.js';
import {
  f as Kt,
  b as Xe,
  P as q,
  ...
  a as Qt,
  u as de,
} from './index-CVQxnTqO.js';
import { u as Qe, a as B, B as Ee } from './button-B39vLLrY.js';
import { u as Jt, a as Yt } from './index-BEpod36D.js';
import { S as Ce } from './SignButton-BTP5NV0u.js';
import './index.esm-BE3Wjq2f.js';
import './index-DPaQe_nL.js';
var ie = { exports: {} },
  se = {};
/**
 * @license React
...
function Zt() {
  ...
  var n = typeof Object.is == 'function' ? Object.is : t,
    ...
    a = e.useDebugValue;
  return (
    (se.useSyncExternalStoreWithSelector = function (u, f, c, d, p) {
      var g = o(null);
      if (g.current === null) {
      ...
      g = s(
        function () {
          function w(S) {
            if (!x) {
              if (((x = !0), (_ = S), (S = d(S)), p !== void 0 && m.hasValue)) {
                var E = m.value;
                if (p(E, S)) return (y = E);
              }
              return (y = S);
            }
            if (((E = y), n(_, S))) return E;
            var R = d(S);
            return p !== void 0 && p(E, R) ? ((_ = S), E) : ((_ = S), (y = R));
          }
          var x = !1,
            _,
            y,
...
var Ae;
function en() {
  return (Ae || ((Ae = 1), (ie.exports = Zt())), ie.exports);
}
var tn = en();
function nn(e) {
  e();
...
function on(e, t) {
  ...
  function c() {
    (o++, n || ((n = e.subscribe(u)), (r = rn())));
  }
  function d() {
    (o--, n && o === 0 && (n(), (n = void 0), r.clear(), (r = je)));
  }
  function p() {
    i || ((i = !0), c());
  }
...
var sn = () =>
  ...
  an = sn(),
  un = () => typeof navigator < 'u' && navigator.product === 'ReactNative',
  cn = un(),
  ln = () => (an || cn ? h.useLayoutEffect : h.useEffect),
  fn = ln(),
  dn = Symbol.for('react-redux-context'),
  pn = typeof globalThis < 'u' ? globalThis : {};
function hn() {
  if (!h.createContext) return {};
  const e = (pn[dn] ??= new Map());
...
function gn(e) {
  ...
  fn(() => {
    ...
    return (
      ...
      u.trySubscribe(),
      s !== o.getState() && u.notifyNestedSubs(),
      () => {
...
function Sn(e = I) {
  const t = e === I ? Je : be(e),
    n = (r, o = {}) => {
      const { equalityFn: i = vn } =
          typeof o == 'function' ? { equalityFn: o } : o,
        s = t(),
        { store: a, subscription: u, getServerState: f } = s;
      h.useRef(!0);
      const c = h.useCallback(
        ...
        d = tn.useSyncExternalStoreWithSelector(
          u.addNestedSub,
          a.getState,
          f || a.getState,
          c,
...
var xn = Sn();
const { slice: _n, forEach: kn } = [];
function En(e) {
  return (
    kn.call(_n.call(arguments, 1), (t) => {
...
const Pe = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
  Rn = function (e, t) {
    ...
    if (r.domain) {
      if (!Pe.test(r.domain)) throw new TypeError('option domain is invalid');
      i += `; Domain=${r.domain}`;
    }
    if (r.path) {
      if (!Pe.test(r.path)) throw new TypeError('option path is invalid');
      i += `; Path=${r.path}`;
    }
    if (r.expires) {
...
var An = {
    ...
    lookup(e) {
      ...
      if (t && typeof document < 'u') return Ne.read(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      ...
      n && typeof document < 'u' && Ne.create(n, e, r, o, i);
    },
  },
  jn = {
    name: 'querystring',
...
const Ie = () => {
  if (D !== null) return D;
  try {
    if (((D = typeof window < 'u' && window.localStorage !== null), !D))
      return !1;
...
var Nn = {
  ...
  lookup(e) {
    ...
    if (t && Ie()) return window.localStorage.getItem(t) || void 0;
  },
  cacheUserLanguage(e, t) {
    let { lookupLocalStorage: n } = t;
    n && Ie() && window.localStorage.setItem(n, e);
  },
};
let M = null;
const Le = () => {
...
var In = {
    ...
    lookup(e) {
      ...
      if (t && Le()) return window.sessionStorage.getItem(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      let { lookupSessionStorage: n } = t;
      n && Le() && window.sessionStorage.setItem(n, e);
    },
  },
  Ln = {
    name: 'navigator',
...
class tt {
  ...
  init() {
    ...
    ((this.services = t),
      (this.options = En(n, this.options || {}, Mn())),
...
const Fn = {
    type: '3rdParty',
    init(e) {
      (Vt(e.options.react), Wt(e));
    },
  },
  Un = (e, t = {}) =>
    function (r) {
      function o({ forwardedRef: s, ...a }) {
        const [u, f, c] = ee(e, { ...a, keyPrefix: t.keyPrefix }),
          d = { ...a, t: u, i18n: f, tReady: c };
        return (
          t.withRef && s
            ? (d.ref = s)
      ...
      ((o.displayName = `withI18nextTranslation(${Gt(r)})`),
  ...
  Bn = { name: 'Name', email: 'Email', password: 'Password', submit: 'Submit' },
  zn = { english: 'English', russian: 'Russian' },
  Hn = {
    title: 'RESTClient',
    history: 'History',
  ...
  Kn = { title: 'Something went wrong', tryAgain: 'Try again' },
  Xn = {
    send: 'Send',
    copy: 'Copy',
    close: 'Close',
  ...
  Qn = { restfull: 'Restfull', variables: 'Variables', history: 'History' },
  Jn = {
    title: 'Variables',
    addButton: 'Add',
  ...
  ir = { english: 'Английский', russian: 'Русский' },
  sr = {
    title: 'RESTClient',
    history: 'История',
  ...
  br = { title: 'Что-то пошло не так', tryAgain: 'Попробовать снова' },
  vr = {
    send: 'Отправить',
    copy: 'Копировать',
    close: 'Закрыть',
  ...
  Sr = { restfull: 'Pестфул', variables: 'Переменные', history: 'История' },
  xr = {
    title: 'Переменные',
    addButton: 'Добавить',
...
qt.use(tt)
  ...
  .init({
    debug: !0,
    resources: { en: { translation: nr }, ru: { translation: Rr } },
    lng: Ar(),
    fallbackLng: 'en',
      ...
      ? l.jsx('footer', {
          ...
          children: l.jsxs('div', {
            ...
            children: [
              ...
              l.jsx('span', { className: 'text-purple-600', children: '2025' }),
              l.jsx('a', {
...
var te = 'Switch',
  ...
  rt = h.forwardRef((e, t) => {
    const {
      ...
      [x, _] = Kt({ prop: o, defaultProp: i ?? !1, onChange: f, caller: te });
    return l.jsxs(Lr, {
      scope: n,
      checked: x,
      disabled: a,
      ...
      return (
        h.useEffect(() => {
          ...
          const d = window.HTMLInputElement.prototype,
            g = Object.getOwnPropertyDescriptor(d, 'checked').set;
          if (u !== n && g) {
            const m = new Event('click', { bubbles: r });
            (g.call(c, n), c.dispatchEvent(m));
          }
        }, [u, n, r]),
        l.jsx('input', {
          type: 'checkbox',
...
var ut = rt,
  Dr = it;
const ct = h.forwardRef(({ className: e, ...t }, n) =>
  l.jsx(ut, {
    className: B(
...
function lt(e, t, n) {
  if (typeof e != 'function') throw new Error(k(2));
  if (
  ...
  function d(w) {
    if (typeof w != 'function') throw new Error(k(4));
    ...
    return (
      ...
      function () {
        if (x) {
          ...
          ((x = !1), f(), s.delete(_), (i = null));
        }
      }
    );
  }
  function p(w) {
    if (!ve(w)) throw new Error(k(7));
    if (typeof w.type > 'u') throw new Error(k(8));
    if (typeof w.type != 'string') throw new Error(k(17));
  ...
  function g(w) {
    if (typeof w != 'function') throw new Error(k(10));
    ((r = w), p({ type: X.REPLACE }));
  }
  function m() {
    const w = d;
    return {
      subscribe(x) {
        if (typeof x != 'object' || x === null) throw new Error(k(11));
        function _() {
          const b = x;
          b.next && b.next(c());
        }
        return (_(), { unsubscribe: w(_) });
      },
      [Te]() {
        return this;
      },
  ...
  return (
    p({ type: X.INIT }),
    { dispatch: p, subscribe: d, getState: c, replaceReducer: g, [Te]: m }
  );
}
function Ur(e) {
  Object.keys(e).forEach((t) => {
    const n = e[t];
    if (typeof n(void 0, { type: X.INIT }) > 'u') throw new Error(k(12));
    if (typeof n(void 0, { type: X.PROBE_UNKNOWN_ACTION() }) > 'u')
  ...
  return function (s = {}, a) {
    ...
    for (let c = 0; c < r.length; c++) {
      const d = r[c],
        ...
        g = s[d],
        m = p(g, a);
      if (typeof m > 'u') throw (a && a.type, new Error(k(14)));
      ((f[d] = m), (u = u || m !== g));
    }
    return ((u = u || r.length !== Object.keys(s).length), u ? f : s);
  };
}
function Q(...e) {
  return e.length === 0
...
function Br(...e) {
  return (t) => (n, r) => {
    ...
    const s = { getState: o.getState, dispatch: (u, ...f) => i(u, ...f) },
      a = e.map((u) => u(s));
    return ((i = Q(...a)(o.dispatch)), { ...o, dispatch: i });
  };
}
function zr(e) {
  return ve(e) && 'type' in e && typeof e.type == 'string';
}
var ft = Symbol.for('immer-nothing'),
...
function dt(e) {
  ...
  return n === Object
    ? !0
    : typeof n == 'function' && Function.toString.call(n) === Hr;
}
function J(e, t) {
  ne(e) === 0
...
function ne(e) {
  const t = e[A];
  return t ? t.type_ : Array.isArray(e) ? 1 : V(e) ? 2 : re(e) ? 3 : 0;
}
function pe(e, t) {
...
function Se(e, t = !1) {
  return (
    oe(e) ||
      ...
      Object.freeze(e),
      t && Object.values(e).forEach((n) => Se(n, !0))),
    e
  );
}
function W() {
...
function ge(e) {
  (me(e), e.drafts_.forEach(Gr), (e.drafts_ = null));
}
function me(e) {
  e === z && (z = e.parent_);
}
...
function Fe(e, t) {
  ...
  return (
    e !== void 0 && e !== n
      ? (n[A].modified_ && (ge(t), j(4)),
        N(e) && ((e = Y(t, e)), t.parent_ || Z(t, e)),
        t.patches_ &&
          O('Patches').generateReplacementPatches_(
            n[A].base_,
            e,
            t.patches_,
            t.inversePatches_
...
function Y(e, t, n) {
  if (oe(t)) return t;
  const r = t[A];
  if (!r) return (J(t, (o, i) => Ue(e, r, t, o, i, n)), t);
  ...
  if (!r.finalized_) {
    ...
    (r.type_ === 3 && ((i = new Set(o)), o.clear(), (s = !0)),
      J(i, (a, u) => Ue(e, r, o, a, u, n, s)),
      Z(e, o, !1),
      n &&
        e.patches_ &&
        O('Patches').generatePatches_(r, n, e.patches_, e.inversePatches_));
  }
  return r.copy_;
}
function Ue(e, t, n, r, o, i, s) {
  if (T(o)) {
    const a =
        i && t && t.type_ !== 3 && !pe(t.assigned_, r) ? i.concat(r) : void 0,
      u = Y(e, o, a);
    if ((pt(n, r, u), T(u))) e.canAutoFreeze_ = !1;
    else return;
  } else s && n.add(o);
  if (N(o) && !oe(o)) {
    ...
    (Y(e, o),
      (!t || !t.scope_.parent_) &&
        typeof r != 'symbol' &&
        (V(n) ? n.has(r) : Object.prototype.propertyIsEnumerable.call(n, r)) &&
        Z(e, o));
  }
}
function Z(e, t, n = !1) {
...
var xe = {
    get(e, t) {
      if (t === A) return e;
      const n = L(e);
      if (!pe(n, t)) return Xr(e, n, t);
      const r = n[t];
      return e.finalized_ || !N(r)
        ? r
        : r === ue(e.base_, t)
          ? (ce(e), (e.copy_[t] = we(r, e)))
          : r;
    },
    has(e, t) {
      return t in L(e);
    ...
    set(e, t, n) {
      ...
      if (!e.modified_) {
        ...
        if (qr(n, o) && (n !== void 0 || pe(e.base_, t))) return !0;
        (ce(e), ye(e));
      }
      return (
    ...
    deleteProperty(e, t) {
      return (
        ue(e.base_, t) !== void 0 || t in e.base_
          ? ((e.assigned_[t] = !1), ce(e), ye(e))
...
var Qr = class {
    ...
    ((this.autoFreeze_ = !0),
      ...
      (this.produce = (t, n, r) => {
        ...
        if (N(t)) {
          ...
          return (De(i, r), Fe(o, i));
        } else if (!t || typeof t != 'object') {
          if (
            ((o = n(t)),
            o === void 0 && (o = t),
            o === ft && (o = void 0),
            this.autoFreeze_ && Se(o, !0),
            r)
          ) {
            const i = [],
              s = [];
            (O('Patches').generateReplacementPatches_(t, o, i, s), r(i, s));
          }
          return o;
        } else j(1, t);
      }),
  ...
  createDraft(e) {
    ...
    const t = Me(this),
      n = we(e, void 0);
    return ((n[A].isManual_ = !0), me(t), n);
  }
  finishDraft(e, t) {
    const n = e && e[A];
    (!n || !n.isManual_) && j(9);
    const { scope_: r } = n;
    return (De(r, t), Fe(void 0, r));
  }
  setAutoFreeze(e) {
    this.autoFreeze_ = e;
  }
  ...
  applyPatches(e, t) {
    ...
    n > -1 && (t = t.slice(n + 1));
    const r = O('Patches').applyPatches_;
    return T(e) ? r(e, t) : this.produce(e, (o) => r(o, t));
  }
};
function we(e, t) {
  const n = V(e)
    ? O('MapSet').proxyMap_(e, t)
    : re(e)
      ? O('MapSet').proxySet_(e, t)
      : Kr(e, t);
  return ((t ? t.scope_ : ht()).drafts_.push(n), n);
}
function Jr(e) {
  return (T(e) || j(10, e), mt(e));
}
function mt(e) {
  if (!N(e) || oe(e)) return e;
  const t = e[A];
  let n;
  if (t) {
...
var ro = () =>
    function (t) {
      ...
      let s = new bt();
      return (n && (no(n) ? s.push(Zr) : s.push(eo(n.extraArgument))), s);
    },
  oo = 'RTK_autoBatch',
  ze = (e) => (t) => {
    setTimeout(t, e);
  ...
  so = (e) =>
    function (n) {
      ...
      let o = new bt(e);
      return (r && o.push(io(typeof r == 'object' ? r : void 0)), o);
    };
function ao(e) {
  const t = ro(),
    {
  ...
  else throw new Error(P(1));
  let u;
  typeof r == 'function' ? (u = r(t)) : (u = t());
  let f = Q;
  o && (f = to({ trace: !1, ...(typeof o == 'object' && o) }));
  const c = Br(...u),
    d = so(c);
...
function vt(e) {
  ...
  const o = {
    addCase(i, s) {
      ...
      if (!a) throw new Error(P(28));
      if (a in t) throw new Error(P(29));
      return ((t[a] = s), o);
    },
    addAsyncThunk(i, s) {
      return (
...
var lo = Symbol.for('rtk-slice-createasyncthunk');
function fo(e, t) {
  return `${e}/${t}`;
}
function po({ creators: e } = {}) {
  const t = e?.asyncThunk?.[lo];
  return function (r) {
    const { name: o, reducerPath: i = o } = r;
    if (!o) throw new Error(P(11));
    const s =
        (typeof r.reducers == 'function' ? r.reducers(mo()) : r.reducers) || {},
      a = Object.keys(s),
      u = {
      ...
      f = {
        addCase(y, b) {
          ...
          if (!S) throw new Error(P(12));
          if (S in u.sliceCaseReducersByType) throw new Error(P(13));
          return ((u.sliceCaseReducersByType[S] = b), f);
        },
        addMatcher(y, b) {
          return (u.sliceMatchers.push({ matcher: y, reducer: b }), f);
        },
        exposeAction(y, b) {
          return ((u.actionCreators[y] = b), f);
        },
        exposeCaseReducer(y, b) {
          return ((u.sliceCaseReducersByName[y] = b), f);
        },
      };
    a.forEach((y) => {
      const b = s[y],
    ...
    function c() {
      const [y = {}, b = [], S = void 0] =
          typeof r.extraReducers == 'function'
            ? vt(r.extraReducers)
            : [r.extraReducers],
        E = { ...y, ...u.sliceCaseReducersByType };
      return co(r.initialState, (R) => {
        for (let C in E) R.addCase(C, E[C]);
        for (let C of u.sliceMatchers) R.addMatcher(C.matcher, C.reducer);
        for (let C of b) R.addMatcher(C.matcher, C.reducer);
        S && R.addDefaultCase(S);
      });
    }
    const d = (y) => y,
      p = new Map(),
    ...
    function x(y, b = !1) {
      function S(R) {
        let C = R[y];
        return (typeof C > 'u' && b && (C = G(g, S, w)), C);
      }
      function E(R = d) {
        const C = G(p, b, () => new WeakMap());
        return G(C, R, () => {
          const ke = {};
          for (const [Tt, Ot] of Object.entries(r.selectors ?? {}))
            ke[Tt] = ho(Ot, R, () => G(g, R, w), b);
          return ke;
        });
      }
      return {
    ...
    const _ = {
      ...
      getInitialState: w,
      ...x(i),
      injectInto(y, { reducerPath: b, ...S } = {}) {
        const E = b ?? i;
        return (
          y.inject({ reducerPath: E, reducer: v }, S),
          { ..._, ...x(E, !0) }
        );
      },
    };
...
function yo({ type: e, reducerName: t, createNotation: n }, r, o) {
  let i, s;
  if ('reducer' in r) {
    if (n && !bo(r)) throw new Error(P(17));
    ((i = r.reducer), (s = r.prepare));
  } else i = r;
  o.addCase(e, i)
    .exposeCaseReducer(t, i)
    .exposeAction(t, s ? $e(e, s) : $e(e));
}
function wo(e) {
...
function vo({ type: e, reducerName: t }, n, r, o) {
  if (!o) throw new Error(P(18));
  const {
      payloadCreator: i,
      fulfilled: s,
      pending: a,
...
const So = {
  ...
  { setLanguage: He } = St.actions,
  xo = St.reducer,
  _o = nt();
function ko({ initialLang: e = _o }) {
  const t = bn(),
    n = xn((c) => c.language.lang),
    { t: r, i18n: o } = ee(),
    [i, s] = h.useState(!1);
  h.useEffect(() => {
    const c = nt();
    (c && c !== n && (t(He(c)), o.changeLanguage(c)), s(!0));
  }, []);
  const a = (c) => (typeof window > 'u' ? o.getFixedT(e)(c) : r(c));
  h.useEffect(() => {
  ...
  const u = () => {
    ...
    (t(He(c)),
      typeof document < 'u' &&
        (document.cookie = `lang=${c}; path=/; max-age=31536000`),
      o.changeLanguage(c),
  ...
  return l.jsxs('div', {
    ...
    children: [
      ...
      l.jsx(ct, { onClick: u, checked: n === 'ru' }),
      l.jsx('div', {
...
const Eo = '/assets/user-icon-DrdDAtoT.jpg';
var le = { exports: {} },
  fe = {};
/**
 * @license React
...
function Co() {
  ...
  function a(d, p) {
    var g = p(),
      m = r({ inst: { value: g, getSnapshot: p } }),
      v = m[0].inst,
      w = m[1];
    return (
      i(
        function () {
          ((v.value = g), (v.getSnapshot = p), u(v) && w({ inst: v }));
        },
        [d, g, p]
      ),
      o(
...
var Ve;
function Ro() {
  return (Ve || ((Ve = 1), (le.exports = Co())), le.exports);
}
var Ao = Ro();
function jo() {
  return Ao.useSyncExternalStore(
    Po,
    () => !0,
    () => !1
  );
...
var kt = 'AvatarImage',
  Et = h.forwardRef((e, t) => {
    ...
    return (
      ...
      a === 'loaded' ? l.jsx(q.img, { ...i, ref: t, src: r }) : null
    );
  });
Et.displayName = kt;
...
function Lo(e, { referrerPolicy: t, crossOrigin: n }) {
  const r = jo(),
    o = h.useRef(null),
    i = r ? (o.current || (o.current = new window.Image()), o.current) : null,
    [s, a] = h.useState(() => We(i, e));
  return (
    de(() => {
      a(We(i, e));
    }, [i, e]),
    de(() => {
      ...
      return (
        ...
        () => {
          (i.removeEventListener('load', f), i.removeEventListener('error', c));
        }
      );
    }, [i, n, t]),
    s
...
var At = _t,
  jt = Et,
  Pt = Rt;
const Nt = h.forwardRef(({ className: e, ...t }, n) =>
  l.jsx(At, {
    ref: n,
    className: B(
...
const It = h.forwardRef(({ className: e, ...t }, n) =>
  l.jsx(jt, { ref: n, className: B('aspect-square h-full w-full', e), ...t })
);
It.displayName = jt.displayName;
...
function To() {
  ...
  const i =
    ...
    { t: s, ready: a } = ee(),
    { user: u, setUser: f, setToken: c } = Ut(),
    d = Ke(),
    p = async () => {
      try {
        const { logout: g } = await $t(
          async () => {
            const { logout: m } = await import('./firebase-BROQ1CJd.js').then(
              (v) => v.f
            );
            return { logout: m };
          },
        ...
        (await g(), f(null), c(null), d('/'), console.log('Log out'));
      } catch (g) {
        console.error('Log error', g);
      }
    };
  return !e || !a
    ? null
    : l.jsx('header', {
        ...
        children: l.jsx('div', {
          className:
            `sticky top-0 z-50 w-full backdrop-blur-sm  px-4 py-2 ${i ? '' : 'transition-all duration-300 ease-in-out'} ` +
            (n
          ...
          children: l.jsxs('nav', {
            ...
            children: [
              ...
              l.jsx('div', {
                className:
                  'flex flex-row items-center justify-center  w-[200px]',
              }),
              u
                ? l.jsxs(l.Fragment, {
                    children: [
                        ...
                        children: l.jsxs('div', {
                          ...
                          children: [
                            l.jsxs(Nt, {
                              children: [
                                l.jsx(It, { src: Eo }),
                                l.jsx(Lt, { children: 'CN' }),
                              ],
                            }),
                            l.jsx('span', { children: u.displayName }),
                          ],
                        }),
                      }),
                    ],
                ...
                : l.jsxs('div', {
                    ...
                    children: [
                      l.jsx(U, {
                        ...
                        children: l.jsx(Ce, { text: s('auth.signIn') }),
                      }),
                      l.jsx(U, {
                        to: '/signUp',
                        end: !0,
                        children: l.jsx(Ce, { text: s('auth.signUp') }),
                      }),
                    ],
                  }),
            ],
...
const Oo = ao({ reducer: { language: xo } }),
  Ko = Dt(function () {
    const t = Ke();
    return (
      h.useEffect(() => {
                    ...
                    children: [
                      ...
                      l.jsx('main', {
                        ...
                        children: l.jsx('div', {
                          ...
                          children: l.jsx(Pr, { children: l.jsx(Mt, {}) }),
                        }),
                      }),
                      l.jsx(Ft, {}),
                      l.jsx(Nr, {}),
