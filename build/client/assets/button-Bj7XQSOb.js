import { r as x, j as te } from './chunk-PVWAREVJ-DHjQzAty.js';
function be(e, t) {
...
function Mr(...e) {
  return x.useCallback(Ce(...e), e);
}
function je(e) {
  const t = _e(e),
    r = x.forwardRef((o, n) => {
      const { children: i, ...l } = o,
        p = x.Children.toArray(i),
        d = p.find(Be);
      if (d) {
        const f = d.props.children,
          g = p.map((y) =>
            y === d
              ? x.Children.count(f) > 1
        ...
        return te.jsx(t, {
          ...l,
          ref: n,
          children: x.isValidElement(f) ? x.cloneElement(f, void 0, g) : null,
        });
      }
      return te.jsx(t, { ...l, ref: n, children: i });
    });
  ...
  const t = x.forwardRef((r, o) => {
    ...
    if (x.isValidElement(n)) {
      const l = Fe(n),
        p = We(i, n.props);
      return (
        n.type !== x.Fragment && (p.ref = o ? Ce(o, l) : l),
        x.cloneElement(n, p)
      );
    }
...
const ie = '-',
  $e = (e) => {
    ...
    return {
      getClassGroupId: (l) => {
        const p = l.split(ie);
        return (p[0] === '' && p.length !== 1 && p.shift(), Ae(p, t) || Ue(l));
      },
...
const b = (e) => {
  ...
  Ge = (e) => e === 'image' || e === 'url',
  Ne = (e) => e === 'length' || e === 'size' || e === 'bg-size',
  Ve = (e) => e === 'length',
  xr = (e) => e === 'number',
  wr = (e) => e === 'family-name',
  Te = (e) => e === 'shadow',
  vr = () => {
    const e = b('color'),
      ...
      m = () => [a, s, d],
      A = () => [_, 'full', 'auto', ...m()],
      le = () => [P, 'none', 'subgrid', a, s],
      ce = () => ['auto', { span: ['full', P, a, s] }, P, a, s],
      D = () => [P, 'auto', a, s],
      ...
      pe = () => ['auto', 'cover', 'contain', hr, fr, { size: [a, s] }],
      Y = () => [re, $, V],
      w = () => ['', 'none', 'full', f, a, s],
      C = () => ['', u, $, V],
    ...
    return {
      ...
      classGroups: {
        ...
        grow: [{ grow: ['', u, a, s] }],
        shrink: [{ shrink: ['', u, a, s] }],
        order: [{ order: [P, 'first', 'last', 'none', a, s] }],
        ...
        'max-w': [
          { 'max-w': [p, 'screen', 'none', 'prose', { screen: [l] }, ...N()] },
        ],
        h: [{ h: ['screen', 'lh', ...N()] }],
        ...
        'text-decoration-thickness': [
          { decoration: [u, 'from-font', 'auto', a, V] },
        ],
        ...
        'text-shadow': [{ 'text-shadow': ['none', z, Z, X] }],
        ...
        'drop-shadow': [{ 'drop-shadow': ['', 'none', I, Z, X] }],
...
const ve = (e) => (typeof e == 'boolean' ? `${e}` : e === 0 ? '0' : e),
  ...
  zr = (e, t) => (r) => {
    ...
    const { variants: n, defaultVariants: i } = t,
      ...
      d =
        t == null || (o = t.compoundVariants) === null || o === void 0
          ? void 0
          : o.reduce((f, g) => {
              let { class: y, className: z, ...I } = g;
              return Object.entries(I).every((v) => {
                let [k, S] = v;
    ...
    return ke(e, l, d, r?.class, r?.className);
  },
  Sr = zr(
  ...
  Ar = x.forwardRef(
    ({ className: e, variant: t, size: r, asChild: o = !1, ...n }, i) => {
      const l = o ? Oe : 'button';
      return te.jsx(l, {
        className: Cr(Sr({ variant: t, size: r, className: e })),
        ref: i,
        ...n,
      });
    }
...
export { Ar as B, Cr as a, zr as b, je as c, Mr as u };
