...
var _r;
function ia() {
  return (_r || ((_r = 1), (Ht.exports = oa())), Ht.exports);
}
var fl = ia(),
  zt = { exports: {} },
  W = {};
...
function la() {
  ...
  var D = (x.prototype = new P());
  ((D.constructor = x), R(D, E.prototype), (D.isPureReactComponent = !0));
  var M = Array.isArray,
    S = { H: null, A: null, T: null, S: null, V: null },
    p = Object.prototype.hasOwnProperty;
  function _(f, b, F, I, Y, Z) {
    return (
      (F = Z.ref),
  ...
  function z(f, b) {
    return _(f.type, b, void 0, void 0, void 0, f.props);
  }
  function H(f) {
  ...
  return (
    ...
    (W.cloneElement = function (f, b, F) {
      ...
      return _(f.type, Y, void 0, void 0, Z, I);
    }),
    ...
    (W.createElement = function (f, b, F) {
      ...
      return _(f, Z, void 0, void 0, null, Y);
    }),
...
var Ar;
function sa() {
  return (Ar || ((Ar = 1), (zt.exports = la())), zt.exports);
}
var h = sa();
const ua = aa(h),
  hl = na({ __proto__: null, default: ua }, [h]);
/**
 * react-router v7.9.1
 *
 ...
 */ var rn = (e) => {
  ...
  ca = (e, t, r) => t.has(e) || rn('Cannot ' + r),
  Bt = (e, t, r) => (
    ca(e, t, 'read from private field'),
    r ? r.call(e) : t.get(e)
  ),
  da = (e, t, r) =>
    t.has(e)
...
var nt,
  kr = class {
    constructor(e) {
      if ((da(this, nt, new Map()), e)) for (let [t, r] of e) this.set(t, r);
    }
    get(e) {
...
nt = new WeakMap();
var ma = new Set(['lazy', 'caseSensitive', 'path', 'id', 'index', 'children']);
function pa(e) {
  return ma.has(e);
}
var ya = new Set([
...
function on(e, t = [], r = [], n = '', a = !1) {
  let o = (i, s, l = a, u) => {
    ...
    (i.children &&
      ...
      on(i.children, t, v, m, l)),
      !(i.path == null && !i.index) &&
        t.push({ path: m, score: Ca(m, i.index), routesMeta: v }));
  };
  return (
    e.forEach((i, s) => {
      if (i.path === '' || !i.path?.includes('?')) o(i, s);
      else for (let l of ln(i.path)) o(i, s, !0, l);
    }),
    t
  );
}
...
function Ca(e, t) {
  ...
  return (
    ...
    r
      .filter((a) => !Fr(a))
      .reduce((a, o) => a + (Ea.test(o) ? Ra : o === '' ? Sa : xa), n)
  );
}
function La(e, t) {
  ...
  for (let s = 0; s < n.length; ++s) {
    ...
    (Object.assign(a, m.params),
      i.push({
        ...
        pathnameBase: Aa(Pe([o, m.pathnameBase])),
        route: v,
      }),
...
function Ct(e, t) {
  ...
  let [r, n] = sn(e.path, e.caseSensitive, e.end),
    a = t.match(r);
  if (!a) return null;
  let o = a[0],
    i = o.replace(/(.)\/+$/, '$1'),
...
function pl(e) {
  ...
  function Bn() {
    (B || (B = po()), Ft(), ce({ revalidation: 'loading' }));
    let c = B.promise;
  ...
  async function ke(c, y, g) {
    ...
    let j = Je(e.history, y, H.signal, g && g.submission),
      U = e.getContext ? await e.getContext() : new kr(),
      k;
    if (g && g.pendingError)
  ...
  async function Wn(c, y, g, C, L, A, $, O = {}) {
    Ft();
    let j = co(y, g);
  ...
  async function Yn(c, y, g, C, L, A, $, O, j, U, k, N) {
    ...
    if (se) {
      ...
      (ee.length > 0 && (q.fetchers = Vn(ee)), ce(q, { flushSync: k }));
    }
    ee.forEach((q) => {
    ...
    let { loaderResults: qe, fetcherResults: _e } = await Er(re, ee, c, C);
    if (c.signal.aborted) return { shortCircuited: !0 };
    ...
    let { loaderData: Ut, errors: Qe } = Vr(p, g, qe, N, ee, _e);
  ...
  async function Jn(c, y, g, C) {
    ...
    let G = e.getContext ? await e.getContext() : new kr(),
      te = (C && C.preventScrollReset) === !0;
    if (k && ye(k.formMethod)) {
      await Kn(c, y, U, O, G, j.active, L, te, k);
      return;
    }
    (b.set(c, { routeId: y, path: U }),
      await Gn(c, y, U, O, G, j.active, L, te, k));
  }
  async function Kn(c, y, g, C, L, A, $, O, j) {
    (Ft(), b.delete(c));
    let U = p.fetchers.get(c);
    Me(c, fo(j, U), { flushSync: $ });
    ...
    (je
      ...
      .forEach((le) => {
        let pt = le.key,
          ...
          ra = tt(void 0, Mr ? Mr.data : void 0);
        (p.fetchers.set(pt, ra),
          De(pt),
          le.controller && V.set(pt, le.controller));
      }),
      ce({ fetchers: new Map(p.fetchers) }));
    let ht = () => je.forEach((le) => De(le.key));
    ...
    let { loaderData: Ve, errors: Ue } = Vr(p, _e, mt, void 0, je, q);
    (xr(xe),
      p.navigation.state === 'loading' && xe > ue
        ...
        : (ce({
            errors: Ue,
            loaderData: Jr(p.loaderData, Ve, _e, Ue),
            fetchers: new Map(p.fetchers),
          }),
          (Q = !1)));
  }
  ...
  async function Fe(
    ...
    let te = C || L;
    if (Ba.has(y.response.status) && te && ye(te.formMethod))
      await ke(U, j, {
  ...
  async function Xe(c, y, g, C) {
    ...
    for (let [$, O] of Object.entries(L))
      if (so(O)) {
        let j = O.result;
        A[$] = { type: 'redirect', response: no(j, c, $, y, l) };
      } else A[$] = await ro(O);
    return A;
  }
  ...
  function It(c) {
    ...
    (V.has(c) && !(y && y.state === 'loading' && ve.has(c)) && De(c),
      b.delete(c),
      ve.delete(c),
      f.delete(c),
      I.delete(c),
    ...
    for (let [g, C] of ve)
      if (C < c) {
        ...
        (J(L, `Expected fetcher: ${g}`),
          L.state === 'loading' && (De(g), ve.delete(g), y.push(g)));
      }
...
function qt(e, t, r, n, a, o) {
  ...
  let l = _t(n || '.', Dt(i), Ee(e.pathname, r) || e.pathname, o === 'path');
  if (
...
function Ir(e, t, r) {
  if (!r || !Ja(r)) return { path: t };
  if (r.formMethod && !uo(r.formMethod))
...
function jr(e, t, r, n, a, o, i, s, l, u, d, m, v, w, R, T, E, P, x, D) {
  let M = D ? (ge(D[1]) ? D[1].error : D[1].data) : void 0,
          ...
          : ae.lazy
            ...
            : ae.loader == null
              ...
              : d
                ...
                : Ka(o.loaderData, o.matches[Q], X) && (V = !0),
        V !== null)
      )
  ...
  return 'id' in e && 'id' in t && e.id === t.id
    ...
    : e.index === t.index &&
      ...
      ? (!e.children || e.children.length === 0) &&
        ...
        ? !0
        : e.children.every((r, n) => t.children?.some((a) => hn(r, a)))
      : !1;
}
var Hr = new WeakMap(),
...
function Xa(e, t, r, n, a) {
  ...
  for (let d of i) {
    ...
    let m = mn({ key: d, route: e, manifest: r, mapRouteProperties: n });
    m && (s.push(m), d === t && (l = m));
  }
...
async function qa(e) {
  return e.matches.some((t) => t.route.middleware) ? pn(e, () => Br(e)) : Br(e);
}
function pn(e, t) {
  return Qa(e, t, (n) => n, io, r);
  function r(n, a, o) {
    if (o)
      return Promise.resolve(
...
async function yn(e, t, r, n, a, o, i = 0) {
  ...
  let [u, d] = l,
    ...
    v = async () => {
      ...
      try {
        return ((m = { value: await yn(e, t, r, n, a, o, i + 1) }), m.value);
      } catch (w) {
...
function vn(e, t, r, n, a) {
  let o = mn({
    ...
    i = Xa(n.route, ye(r.method) ? 'action' : 'loader', t, e, a);
  return {
    middleware: o,
  ...
  return n.map((l) =>
    l.route.id !== a.route.id
      ? {
          ...
          _lazyPromises: vn(e, t, r, l, o),
          resolve: () => Promise.resolve({ type: 'data', result: void 0 }),
        }
      : Zt(e, t, r, l, o, i, !0, s)
  );
}
async function Za(e, t, r, n, a, o) {
...
function Je(e, t, r, n) {
  let a = e.createURL(gn(t)).toString(),
    o = { signal: r };
...
function Vr(e, t, r, n, a, o) {
  let { loaderData: i, errors: s } = ao(t, r, n);
  return (
    a
...
function io(e) {
  return (
    e != null &&
    typeof e == 'object' &&
    Object.entries(e).every(([t, r]) => typeof t == 'string' && lo(r))
  );
}
function lo(e) {
  return (
...
function so(e) {
  return sr(e.result) && za.has(e.result.status);
}
function ge(e) {
  return e.type === 'error';
}
...
var yo = h.createContext(!1);
function vo() {
  return h.useContext(yo);
}
var cr = h.createContext({ isTransitioning: !1 });
cr.displayName = 'ViewTransition';
var wn = h.createContext(new Map());
wn.displayName = 'Fetchers';
var go = h.createContext(null);
...
function Eo() {
  ...
  return (
    ...
    h.useCallback(
      (l, u = {}) => {
        if ((ne(i.current, En), !i.current)) return;
        if (typeof l == 'number') {
          r.go(l);
          return;
        }
        let d = _t(l, JSON.parse(o), a, u.relative === 'path');
        (e == null &&
          t !== '/' &&
...
function bo(e) {
  ...
  return t && h.createElement(Ro.Provider, { value: e }, t);
}
function So() {
...
function st(e, { relative: t } = {}) {
  let { matches: r } = h.useContext(Re),
    { pathname: n } = Te(),
    a = JSON.stringify(Dt(r));
  return h.useMemo(() => _t(e, JSON.parse(a), n, t === 'path'), [e, a, n, t]);
}
...
var Co = h.createElement(Po, null),
  Lo = class extends h.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
...
function To({ routeContext: e, match: t, children: r }) {
...
function Mo(e, t = [], r = null, n = null, a = null) {
  if (e == null) {
    if (!r) return null;
...
function Ao() {
  ...
  return h.useMemo(() => e.map((r) => an(r, t)), [e, t]);
}
function No() {
...
var vl = ['HydrateFallback', 'hydrateFallbackElement'],
  Fo = class {
    constructor() {
      ((this.status = 'pending'),
...
function gl({ router: e, flushSync: t, unstable_onError: r }) {
  let [n, a] = h.useState(e.state),
      ...
      (S) => {
        a(
          (p) => (
            S.errors &&
              r &&
              Object.entries(S.errors).forEach(([_, z]) => {
                p.errors?.[_] !== z && r(z);
              }),
            S
          )
    ...
    P = h.useCallback(
      (S, { deletedFetchers: p, flushSync: _, viewTransitionOpts: z }) => {
        ...
        if (
          ...
          t && _ ? t(() => E(S)) : h.startTransition(() => E(S));
          return;
        }
        if (t && _) {
          t(() => {
  ...
  (h.useLayoutEffect(() => e.subscribe(P), [e, P]),
    h.useEffect(() => {
      s.isTransitioning && !s.flushSync && d(new Fo());
    }, [s]),
    h.useEffect(() => {
      if (u && o && e.window) {
        let S = o,
...
function jo({ routes: e, future: t, state: r, unstable_onError: n }) {
  return xo(e, void 0, r, n, t);
}
function wl({ to: e, replace: t, state: r, relative: n }) {
  J(
    Ge(),
...
function Ho() {
  return { params: So(), loaderData: No(), actionData: $o(), matches: Ao() };
}
function Rl(e) {
  return function () {
    const r = Ho();
    ...
    if (Array.isArray(d))
      if (typeof d[0] == 'string') {
        ...
        switch (m) {
          ...
          case xn:
            const [, P, x] = d;
            let D = x && Kt && Kt[x] ? new Kt[x](P) : new Error(P);
            ((t[l] = D), u(D));
            continue;
          case fi:
            u((t[l] = t[v]));
...
function Ei(e, t, r, n, a, o = () => !0) {
  return async (i) => {
    let { request: s, matches: l, fetcherKey: u } = i,
      d = e();
    if (s.method !== 'GET') return Ri(i, r, a);
    let m = l.some((v) => {
...
async function Ri(e, t, r) {
  ...
  return sr(o.result) || Be(o.result) || tr(o.result)
    ? { [n.route.id]: o }
    : { [n.route.id]: { type: o.type, result: Fa(o.result, a) } };
}
...
async function Si(e, t, r, n, a, o, i = () => !0) {
  let s = new Set(),
    l = !1,
    u = e.matches.map(() => Zr()),
    d = Zr(),
    ...
    v = Promise.all(
      e.matches.map(async (R, T) =>
        R.resolve(async (E) => {
          u[T].resolve();
          let P = R.route.id,
            { hasLoader: x, hasClientLoader: D, hasShouldRevalidate: M } = r(R),
            S =
          ...
          if (i(R) && D) {
            ...
            try {
              ...
              m[P] = { type: 'data', result: _ };
            } catch (_) {
              m[P] = { type: 'error', result: _ };
            }
            return;
          }
          x && s.add(P);
  ...
  return (await v, await xi(d.promise, e.matches, s, m), m);
}
async function xi(e, t, r, n) {
  try {
    let a,
      o = await e;
    if ('routes' in o) {
    ...
    a !== void 0 &&
      Array.from(r.values()).forEach((i) => {
        n[i].result instanceof Ln && (n[i].result = a);
      });
  } catch {}
}
...
async function Li(e, t, r) {
  let { request: n } = e,
    a = Tn(n.url, t, 'data');
  n.method === 'GET' &&
    ((a = Ci(a)), r && a.searchParams.set('_routes', r.join(',')));
  let o = await fetch(a, await vi(n));
...
function it(e, t) {
  ...
  let r = e.routes[t];
  if (r == null) throw new Ln(`No result found for routeId "${t}"`);
...
async function Mi(e) {
  if (!e.css) return;
  let t = Dn(e);
  await Promise.all(t.map(On));
}
async function _n(e, t) {
  if ((!e.css && !t.links) || !ki()) return;
  let r = [];
  if (
...
function An(e, t, { includeHydrateFallback: r } = {}) {
  return Ai(
    e
      .map((n) => {
...
function mr(e, t, r, n, a, o = '', i = Nn(e), s) {
  return (i[o] || []).map((l) => {
    let u = t[l.id];
    function d(x) {
      return (
    ...
    if (u) {
      ...
      ((E.loader = async ({ request: _, params: z, context: H }, K) => {
        ...
        (E.loader.hydrate = Hi(l.id, u.clientLoader, l.hasLoader, a)),
        (E.action = ({ request: _, params: z, context: H }, K) =>
          T(async () => {
            if (
        ...
        middleware: l.hasClientMiddleware
          ? async () => {
              let { clientMiddleware: M } = l.clientMiddlewareModule
                ...
                : await D();
              return (he(M, 'No `clientMiddleware` export found'), M);
            }
          : void 0,
        shouldRevalidate: async () => {
          let M = await D();
          return tn(E.path, M, l, n, s);
        },
...
function tn(e, t, r, n, a) {
  if (a) return ji(r.id, t.shouldRevalidate, a);
  if (!n && r.hasLoader && !r.hasClientLoader) {
    let o = e ? sn(e)[1].map((s) => s.paramName) : [];
...
async function kn(e, t, r, n, a, o, i, s, l, u) {
  ...
  let m = new URL(Yi(s, i), window.location.origin);
  if (((m.search = d.toString()), m.toString().length > Bi)) {
    Pt.clear();
    return;
  }
  let v;
  ...
  (Object.assign(r.routes, R), e.forEach((E) => Vi(E, Tt)));
  let T = new Set();
...
function Xi({ page: e, ...t }) {
  let { router: r } = yr(),
    n = h.useMemo(() => Le(r.routes, e, r.basename), [r.routes, e, r.basename]);
  return n ? h.createElement(Qi, { page: e, matches: n, ...t }) : null;
}
function qi(e) {
...
function Qi({ page: e, matches: t, ...r }) {
  let n = Te(),
    { manifest: a, routeModules: o } = $t(),
    { basename: i } = yr(),
    { loaderData: s, matches: l } = Fn(),
    u = h.useMemo(() => en(e, t, l, a, n, 'data'), [e, t, l, a, n]),
    d = h.useMemo(() => en(e, t, l, a, n, 'assets'), [e, t, l, a, n]),
    m = h.useMemo(() => {
      ...
      if (
        (t.forEach((P) => {
          ...
          !x ||
            !x.hasLoader ||
            ((!u.some((D) => D.route.id === P.route.id) &&
              P.route.id in s &&
...
${w.map((M, S) => {
  let p = `route${S}`,
    _ = t.routes[M.route.id];
  he(_, `Route ${M.route.id} not found in manifest`);
  let {
...
`)}
  ${v ? `window.__reactRouterManifest = ${JSON.stringify(Wi(t, s), null, 2)};` : ''}
...
import(${JSON.stringify(t.entry.module)});`
    ...
    T =
      Mt || m
        ? []
        : tl(t.entry.imports.concat(An(w, t, { includeHydrateFallback: !0 }))),
...
var Cl = class extends h.Component {
  constructor(e) {
  ...
  render() {
    return this.state.error
      ? h.createElement(In, { error: this.state.error, isOutsideRemixApp: !0 })
      : this.props.children;
  }
};
function In({ error: e, isOutsideRemixApp: t }) {
  console.error(e);
    ...
    : h.createElement(
        ...
        h.createElement(
          ...
          h.createElement(
            ...
            n,
            t ? h.createElement(el, null) : null
          )
        )
      );
}
...
try {
  jn && (window.__reactRouterVersion = '7.9.1');
} catch {}
var Un = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Hn = h.forwardRef(function (
    {
      onClick: t,
      discover: r = 'render',
      prefetch: n = 'none',
    ...
    let { basename: R } = h.useContext(be),
      T = typeof u == 'string' && Un.test(u),
      E,
      P = !1;
    if (typeof u == 'string' && T && ((E = u), jn))
      try {
    ...
    return D && !T
      ? h.createElement(h.Fragment, null, z, h.createElement(Xi, { page: x }))
      : z;
  });
Hn.displayName = 'Link';
var nl = h.forwardRef(function (
  {
    'aria-current': t = 'page',
    caseSensitive: r = !1,
    className: n = '',
  ...
  let S = x === P || (!a && x.startsWith(P) && x.charAt(M) === '/'),
    p =
      D != null &&
      (D === P || (!a && D.startsWith(P) && D.charAt(P.length) === '/')),
    _ = { isActive: S, isPending: p, isTransitioning: E },
    z = S ? t : void 0,
    H;
  typeof n == 'function'
    ? (H = n(_))
...
function Ll(e) {
  ...
  let t = h.useRef(nr(e)),
    r = h.useRef(!1),
    n = Te(),
    a = h.useMemo(() => Jo(n.search, r.current ? null : t.current), [n.search]),
    o = fr(),
    i = h.useCallback(
      (s, l) => {
...
var ll = 0,
  sl = () => `__${String(++ll)}__`;
function ul() {
  let { router: e } = zn('useSubmit'),
    { basename: t } = h.useContext(be),
    r = Oo();
  return h.useCallback(
    async (n, a = {}) => {
      let { action: o, method: i, encType: s, formData: l, body: u } = Xo(n, t);
      if (a.navigate === !1) {
        let d = a.fetcherKey || sl();
...
function dl(e, { relative: t } = {}) {
  ...
  let { basename: n } = zn('useViewTransitionState'),
    a = st(e, { relative: t });
