...
import { S as o } from './SignButton-BTP5NV0u.js';
import { u as d } from './AuthContext-CUzW9ehr.js';
import { u } from './useTranslation-CEuFiQrx.js';
import './button-B39vLLrY.js';
const m = '/assets/Darya-Cy8thGTo.jpg',
  p = '/assets/alyona-COSDz4be.jpg',
  b = '/assets/vika-CwH6O9av.jpg',
  w = x(function () {
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsx('div', {
                        ...
                        children: t('aboutVika.name'),
                      }),
                      e.jsx('div', { children: t('aboutVika.text') }),
                      e.jsx('a', {
                        ...
                        children: t('aboutVika.linkGitHub'),
                      }),
                    ],
                  }),
                  e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsx('div', {
                        className:
                          'text-purple-600 font-bold text-center text-xl mb-2 mt-2',
                        children: t('aboutDarya.name'),
                      }),
                      e.jsx('div', { children: t('aboutDarya.text') }),
                      e.jsx('a', {
                        ...
                        children: t('aboutDarya.linkGitHub'),
                      }),
                    ],
                  }),
                  e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsx('div', {
                        className:
                          'text-purple-600 font-bold text-center text-xl mb-2 mt-2',
                        children: t('aboutAlyona.name'),
                      }),
                      e.jsx('div', { children: t('aboutAlyona.text') }),
                      e.jsx('a', {
                        ...
                        className:
                          'text-purple-600 font-bold text-center text-l mb-2 mt-2',
                        children: t('aboutAlyona.linkGitHub'),
                      }),
                    ],
                  }),
                ],
              ...
              e.jsxs('div', {
                ...
                children: [
                  e.jsx(l, {
                    ...
                    children: e.jsx(o, { text: t('auth.signIn') }),
                  }),
                  e.jsx(l, {
                    to: '/signUp',
                    end: !0,
                    children: e.jsx(o, { text: t('auth.signUp') }),
                  }),
                ],
              }),
            ],
