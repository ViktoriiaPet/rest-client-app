...
import { u as Ut, _ as $t, A as Bt } from './AuthContext-Cy9VIbgu.js';
import { i as zt } from './firebase-yRvBWTGt.js';
import { V as Ht } from './VariablesContext-BI_M_qxx.js';
...
import {
  ...
  g as Gt,
  u as ee,
} from './useTranslation-ZsYxALZe.js';
import {
  f as Kt,
  b as Xe,
  P as q,
...
import { u as Qe, a as B, B as Ee } from './button-Bj7XQSOb.js';
import { u as Jt, a as Yt } from './index-B4WRz4II.js';
import { S as Ce } from './SignButton-DCxUp28w.js';
import './index.esm-DEVYYNpo.js';
import './index-Cd_xhWcG.js';
var ie = { exports: {} },
  se = {};
/**
 * @license React
...
function Zt() {
  ...
  var n = typeof Object.is == 'function' ? Object.is : t,
    ...
    a = e.useDebugValue;
  return (
    (se.useSyncExternalStoreWithSelector = function (c, f, u, d, p) {
      var g = o(null);
      if (g.current === null) {
...
var sn = () =>
  ...
  an = sn(),
  cn = () => typeof navigator < 'u' && navigator.product === 'ReactNative',
  un = cn(),
  ln = () => (an || un ? h.useLayoutEffect : h.useEffect),
  fn = ln(),
...
const Fn = {
  ...
  Un = (e, t = {}) =>
    function (r) {
      function o({ forwardedRef: s, ...a }) {
        const [c, f, u] = ee(e, { ...a, keyPrefix: t.keyPrefix }),
  ...
  vr = { title: 'Что-то пошло не так', tryAgain: 'Попробовать снова' },
  br = {
    send: 'Отправить',
    copy: 'Копировать',
    close: 'Закрыть',
      ...
      children: [
        l.jsx(q.button, {
          ...
          onClick: Xt(e.onClick, (y) => {
            (_((v) => !v),
              w &&
                ((b.current = y.isPropagationStopped()),
                b.current || y.stopPropagation()));
          }),
        }),
        w &&
          l.jsx(st, {
...
var ct = rt,
  Dr = it;
const ut = h.forwardRef(({ className: e, ...t }, n) =>
  l.jsx(ct, {
    className: B(
...
function lt(e, t, n) {
  ...
  function u() {
    if (c) throw new Error(k(3));
    return o;
  }
  function d(w) {
    if (typeof w != 'function') throw new Error(k(4));
    if (c) throw new Error(k(5));
    let x = !0;
    f();
    const _ = a++;
    return (
  ...
  return (
    p({ type: X.INIT }),
    { dispatch: p, subscribe: d, getState: u, replaceReducer: g, [Te]: m }
  );
}
function Ur(e) {
...
function Ue(e, t, n, r, o, i, s) {
  if (T(o)) {
    const a =
      ...
      c = Y(e, o, a);
    if ((pt(n, r, c), T(c))) e.canAutoFreeze_ = !1;
    else return;
  } else s && n.add(o);
  if (N(o) && !oe(o)) {
...
function po({ creators: e } = {}) {
  ...
  return function (r) {
    ...
    const s =
      ...
      f = {
        addCase(y, v) {
          ...
          if (S in c.sliceCaseReducersByType) throw new Error(P(13));
          return ((c.sliceCaseReducersByType[S] = v), f);
        },
        addMatcher(y, v) {
          return (c.sliceMatchers.push({ matcher: y, reducer: v }), f);
        },
        exposeAction(y, v) {
          return ((c.actionCreators[y] = v), f);
        },
        exposeCaseReducer(y, v) {
          return ((c.sliceCaseReducersByName[y] = v), f);
        },
      };
    a.forEach((y) => {
      const v = s[y],
    ...
    function u() {
      const [y = {}, v = [], S = void 0] =
          typeof r.extraReducers == 'function'
            ? bt(r.extraReducers)
            : [r.extraReducers],
        E = { ...y, ...c.sliceCaseReducersByType };
      return uo(r.initialState, (R) => {
        for (let C in E) R.addCase(C, E[C]);
        for (let C of c.sliceMatchers) R.addMatcher(C.matcher, C.reducer);
        for (let C of v) R.addMatcher(C.matcher, C.reducer);
    ...
    function x(y, v = !1) {
      function S(R) {
        let C = R[y];
        return (typeof C > 'u' && v && (C = G(g, S, w)), C);
      }
      function E(R = d) {
        const C = G(p, v, () => new WeakMap());
        return G(C, R, () => {
          const ke = {};
          for (const [Tt, Ot] of Object.entries(r.selectors ?? {}))
            ke[Tt] = ho(Ot, R, () => G(g, R, w), v);
          return ke;
        });
      }
      return {
    ...
    const _ = {
      ...
      getInitialState: w,
      ...x(i),
      injectInto(y, { reducerPath: v, ...S } = {}) {
        const E = v ?? i;
        return (
          y.inject({ reducerPath: E, reducer: b }, S),
          { ..._, ...x(E, !0) }
        );
      },
    };
...
function yo({ type: e, reducerName: t, createNotation: n }, r, o) {
  let i, s;
  if ('reducer' in r) {
    if (n && !vo(r)) throw new Error(P(17));
...
function bo({ type: e, reducerName: t }, n, r, o) {
...
function ko({ initialLang: e = _o }) {
  const t = vn(),
    n = xn((u) => u.language.lang),
    { t: r, i18n: o } = ee(),
    [i, s] = h.useState(!1);
  h.useEffect(() => {
    const u = nt();
    (u && u !== n && (t(He(u)), o.changeLanguage(u)), s(!0));
  }, []);
  ...
  return l.jsxs('div', {
    ...
    children: [
      ...
      l.jsx(ut, { onClick: c, checked: n === 'ru' }),
      l.jsx('div', {
...
function Co() {
  ...
  function a(d, p) {
    ...
    return (
      i(
        function () {
          ((b.value = g), (b.getSnapshot = p), c(b) && w({ inst: b }));
        },
        [d, g, p]
      ),
      o(
  ...
  return (
    ...
    de(() => {
      ...
      return (
        ...
        () => {
          (i.removeEventListener('load', f), i.removeEventListener('error', u));
        }
      );
    }, [i, n, t]),
    s
...
function To() {
      ...
      const m = () => {
        o.current === null &&
          (o.current = requestAnimationFrame(() => {
            const b = window.scrollY || window.pageYOffset;
            (r(b > 8), (o.current = null));
          }));
      };
      return (
  ...
  const i =
    ...
    { t: s, ready: a } = ee(),
    { user: c, setUser: f, setToken: u } = Ut(),
    d = Ke(),
    p = async () => {
      try {
        const { logout: g } = await $t(
          async () => {
            const { logout: m } = await import('./firebase-yRvBWTGt.js').then(
              (b) => b.f
            );
            return { logout: m };
          },
        ...
        (await g(), f(null), u(null), d('/'), console.log('Log out'));
      } catch (g) {
                      ...
                      l.jsx(U, {
                        ...
                        children: l.jsxs('div', {
                          ...
                          children: [
                            ...
                            l.jsx('span', { children: c.displayName }),
                          ],
                        }),
                      }),
                    ],
