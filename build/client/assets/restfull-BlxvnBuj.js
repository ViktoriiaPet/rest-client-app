const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/RestFullClient-C94K6gMq.js',
      'assets/chunk-PVWAREVJ-DHjQzAty.js',
      'assets/button-Bj7XQSOb.js',
      'assets/index-BzYe63nO.js',
      'assets/index-Cd_xhWcG.js',
      'assets/index-B4WRz4II.js',
      'assets/x-D9UkY--3.js',
      'assets/useTranslation-ZsYxALZe.js',
      'assets/AuthContext-Cy9VIbgu.js',
      'assets/firebase-yRvBWTGt.js',
      'assets/index.esm-DEVYYNpo.js',
    ])
) => i.map((i) => d[i]);
import { _ as b, u as g } from './AuthContext-Cy9VIbgu.js';
import {
  r as d,
  w as C,
  b as T,
...
import { u as j } from './useTranslation-ZsYxALZe.js';
...
const $ = d.lazy(() =>
    b(
      () => import('./RestFullClient-C94K6gMq.js'),
