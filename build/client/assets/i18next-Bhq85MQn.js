const d = (o) => typeof o == 'string',
  ...
  be = /###/g,
  se = (o) => (o && o.indexOf('###') > -1 ? o.replace(be, '.') : o),
  ie = (o) => !o || d(o),
  A = (o, e, t) => {
    ...
    for (; s < i.length - 1; ) {
      ...
      const n = se(i[s]);
      (!o[n] && t && (o[n] = new t()),
        Object.prototype.hasOwnProperty.call(o, n) ? (o = o[n]) : (o = {}),
        ++s);
    }
    return ie(o) ? {} : { obj: o, k: se(i[s]) };
  },
  ne = (o, e, t) => {
...
const Ce = (o) => (d(o) ? o.replace(/[&<>"'\/]/g, (e) => we[e]) : o);
class Re {
  constructor(e) {
    ((this.capacity = e),
...
const Pe = [' ', ',', '?', '!', ';'],
  ...
  Ne = (o, e, t) => {
    ((e = e || ''), (t = t || ''));
    const i = Pe.filter((r) => e.indexOf(r) < 0 && t.indexOf(r) < 0);
    ...
    for (let n = 0; n < i.length; ) {
      ...
      for (let l = n; l < i.length; ++l)
        if ((l !== n && (a += t), (a += i[l]), (r = s[a]), r !== void 0)) {
          if (
            ['string', 'number', 'boolean'].indexOf(typeof r) > -1 &&
            l < i.length - 1
          )
            continue;
          n += l - n + 1;
...
class J {
  ...
  forward(e, t, i, s) {
    return s && !this.debug
      ? null
      : (d(e[0]) && (e[0] = `${i}${this.prefix} ${e[0]}`), this.logger[t](e));
  }
  create(e) {
...
function Fe() {
  ...
  return (
    (e.get = (i, s) => (
      t?.revoke?.(),
      s === xe ? o : (o.push(s), (t = Proxy.revocable(i, e)), t.proxy)
    )),
...
const ae = {},
  oe = (o) => !d(o) && typeof o != 'boolean' && typeof o != 'number';
class W extends _ {
  constructor(e, t = {}) {
    (super(),
      Oe(
  ...
  translate(e, t, i) {
    ...
    const f = s.lng || this.language,
      g = s.appendNamespaceToCIMode || this.options.appendNamespaceToCIMode;
    ...
    const m = p?.usedKey || a,
      ...
      x = s.joinArrays !== void 0 ? s.joinArrays : this.options.joinArrays,
      F = !this.i18nFormat || this.i18nFormat.handleAsObject,
      b = s.count !== void 0 && !d(s.count),
      N = W.hasDefaultValue(s),
      E = b ? this.pluralResolver.getSuffix(f, s.count, s) : '',
      I =
        s.ordinal && b
          ? this.pluralResolver.getSuffix(f, s.count, { ordinal: !1 })
          : '',
      Z = b && !s.ordinal && s.count === 0,
      k =
        (Z && s[`defaultValue${this.options.pluralSeparator}zero`]) ||
        s[`defaultValue${E}`] ||
        s[`defaultValue${I}`] ||
        s.defaultValue;
    let w = c;
    F && !c && N && (w = k);
    const ye = oe(w),
      Se = Object.prototype.toString.apply(w);
    if (F && w && ye && L.indexOf(Se) < 0 && !(d(x) && Array.isArray(w))) {
        ...
        for (const R in w)
          if (Object.prototype.hasOwnProperty.call(w, R)) {
            ...
            (N && !c
              ? (v[R] = this.translate($, {
                  ...s,
                  defaultValue: oe(k) ? k[R] : void 0,
                  joinArrays: !1,
                  ns: l,
                }))
              : (v[R] = this.translate($, { ...s, joinArrays: !1, ns: l })),
              v[R] === $ && (v[R] = w[R]));
          }
        c = v;
      }
      ...
      let C = !1,
        v = !1;
      (!this.isValidLookup(c) && N && ((C = !0), (c = k)),
      ...
      const R =
          ...
          v
            ? void 0
            : c,
        $ = N && k !== c && this.options.updateMissing;
      if (v || C || $) {
        if (
          (this.logger.log($ ? 'updateKey' : 'missingKey', f, u, a, $ ? k : c),
          r)
        ) {
          const O = this.resolve(a, { ...s, keySeparator: !1 });
          O &&
            O.res &&
            this.logger.warn(
        ...
        if (this.options.saveMissingTo === 'fallback' && H && H[0])
          for (let O = 0; O < H.length; O++) D.push(H[O]);
        else
        ...
        const q = (O, j, V) => {
          ...
          (this.options.missingKeyHandler
            ? this.options.missingKeyHandler(O, u, j, ee, $, s)
            : this.backendConnector?.saveMissing &&
              this.backendConnector.saveMissing(O, u, j, ee, $, s),
            this.emit('missingKey', O, u, j, c));
        };
      ...
      ((c = this.extendTranslation(c, e, s, p, i)),
        ...
        (v || C) &&
          ...
          (c = this.options.parseMissingKeyHandler(
            this.options.appendNamespaceToMissingKey ? `${u}${h}${a}` : a,
            C ? c : void 0,
            s
          )));
    }
        ...
        f.forEach((S) => {
          this.isValidLookup(i) ||
            ...
            m.forEach((L) => {
              ...
              if (this.i18nFormat?.addLookupKeys)
                ...
                if (
                  (g &&
                    (t.ordinal &&
                      b.indexOf(E) === 0 &&
                      x.push(h + b.replace(E, this.options.pluralSeparator)),
                    x.push(h + b),
                    p && x.push(h + N)),
                  c)
                ) {
                  ...
                  (x.push(I),
                    g &&
                      (t.ordinal &&
                        b.indexOf(E) === 0 &&
                        x.push(I + b.replace(E, this.options.pluralSeparator)),
                      x.push(I + b),
                      p && x.push(I + N)));
                }
              }
              ...
              for (; (F = x.pop()); )
                this.isValidLookup(i) ||
                  ((n = F), (i = this.getResource(L, S, F, t)));
            }));
        });
      }),
...
const ue = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
  fe = {
  ...
  getSuffixes(e, t = {}) {
    ...
    return (
      ...
      i
        ? i
            .resolvedOptions()
            .pluralCategories.sort((s, n) => ue[s] - ue[n])
            .map(
              (s) =>
...
const he = (o, e, t, i = '.', s = !0) => {
    let n = ve(o, e, t);
    return (
      !n && s && d(t) && ((n = Q(o, t, i)), n === void 0 && (n = Q(e, t, i))),
      n
    );
  },
  Y = (o) => o.replace(/\$/g, '$$$$');
      ...
      u = (p) => {
        if (p.indexOf(this.formatSeparator) < 0) {
          ...
          return this.alwaysFormat
            ? this.format(L, void 0, i, { ...s, ...t, interpolationkey: p })
            : L;
        }
        ...
        for (a = 0; (n = p.regex.exec(e)); ) {
          ...
          if (((r = u(c)), r === void 0))
            if (typeof h == 'function') {
              const S = h(e, n, s);
              r = d(S) ? S : '';
            } else if (s && Object.prototype.hasOwnProperty.call(s, c)) r = '';
            else if (f) {
              r = n[0];
              continue;
            } else
    ...
    for (; (s = this.nestingRegexp.exec(e)); ) {
      ...
      (d(n) || (n = te(n)),
        ...
        l.length &&
          (n = l.reduce(
            (h, f) =>
              this.format(h, f, i.lng, { ...i, interpolationkey: s[1].trim() }),
            n.trim()
          )),
        (e = e.replace(s[0], n)),
...
class De {
  ...
  init(e, t = { interpolation: {} }) {
    ...
    const i = t.cacheInBuiltFormats ? ce : Te;
    this.formats = {
      number: i((s, n) => {
  ...
  format(e, t, i, s = {}) {
    ...
    return n.reduce((a, l) => {
      const { formatName: u, formatOptions: h } = Ie(l);
      if (this.formats[u]) {
        let f = a;
        try {
...
class Ke extends _ {
  ...
  loaded(e, t, i) {
    ...
    (t && this.emit('failedLoading', n, r, t),
      !t &&
        i &&
        this.store.addResourceBundle(n, r, i, void 0, void 0, { skipCopy: !0 }),
      (this.state[e] = t ? -1 : 2),
      t && i && (this.state[e] = 0));
    const a = {};
  ...
  loadOne(e, t = '') {
    ...
    this.read(s, n, 'read', void 0, void 0, (r, a) => {
      (r &&
        ...
        !r &&
          a &&
          this.logger.log(`${t}loaded namespace ${n} for language ${s}`, a),
        this.loaded(e, r, a));
    });
  }
    ...
    if (!(i == null || i === '')) {
      if (this.backend?.create) {
        ...
        if (u.length < 6)
          try {
            let h;
            (u.length === 5 ? (h = u(e, t, i, s, l)) : (h = u(e, t, i, s)),
...
class M extends _ {
  ...
  init(e = {}, t) {
    ...
    const i = de();
    ((this.options = { ...i, ...this.options, ...pe(e) }),
      (this.options.interpolation = {
        ...i.interpolation,
        ...this.options.interpolation,
      }),
  ...
  use(e) {
    ...
    return (
      ...
      e.type === 'postProcessor' && me.addPostProcessor(e),
      ...
      r = (a) => {
        ...
        const l = d(a) ? a : a && a[0],
          u = this.store.hasLanguageSomeTranslations(l)
            ? l
            : this.services.languageUtils.getBestMatchFromCodes(d(a) ? [a] : a);
        (u &&
          (this.language || s(u),
  ...
  getFixedT(e, t, i) {
    const s = (n, r, ...a) => {
      let l;
      (typeof r != 'object'
        ? (l = this.options.overloadTranslationOptionHandler([n, r].concat(a)))
        : (l = { ...r }),
        (l.lng = l.lng || s.lng),
        (l.lngs = l.lngs || s.lngs),
        (l.ns = l.ns || s.ns),
        l.keyPrefix !== '' && (l.keyPrefix = l.keyPrefix || i || s.keyPrefix));
      ...
      return (
        l.keyPrefix && Array.isArray(n)
          ? (h = n.map(
              (f) => (
                typeof f == 'function' && (f = G(f, { ...this.options, ...r })),
                `${l.keyPrefix}${u}${f}`
              )
            ))
          : (typeof n == 'function' && (n = G(n, { ...this.options, ...r })),
  ...
  loadLanguages(e, t) {
    ...
    const s = this.options.preload || [],
      n = e.filter(
        (r) =>
          s.indexOf(r) < 0 && this.services.languageUtils.isSupportedCode(r)
      );
    return n.length
  ...
  dir(e) {
    ...
    const t = [
      ...
      i = this.services?.languageUtils || new le(de());
...
const y = M.createInstance();
y.createInstance = M.createInstance;
y.createInstance;
y.dir;
y.init;
y.loadResources;
