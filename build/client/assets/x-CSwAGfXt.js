import { r as i, e as rt, j as y } from './chunk-B7RQU5TL-BJE0v3Ur.js';
import {
  u as X,
  a as j,
  P as A,
...
import { u as M, c as ct } from './button-B39vLLrY.js';
import { R as ut } from './index-DPaQe_nL.js';
    ...
    i.useEffect(
      function () {
        if (e.inert) {
          ...
          var c = It([e.lockRef.current], (e.shards || []).map(Se), !0).filter(
            Boolean
          );
          return (
...
var Cn = ct('DialogOverlay.RemoveScroll'),
  ...
  I = 'DialogContent',
  Xe = i.forwardRef((e, t) => {
    const n = $e(I, e.__scopeDialog),
      { forceMount: r = n.forceMount, ...o } = e,
      a = D(I, e.__scopeDialog);
    return y.jsx(z, {
      present: r || a.open,
      children: a.modal
        ? y.jsx(Sn, { ...o, ref: t })
...
var et = 'DialogTitleWarning',
  [jn, tt] = it(et, { contentName: I, titleName: le, docsSlug: 'dialog' }),
  Dn = ({ titleId: e }) => {
    const t = tt(et),
